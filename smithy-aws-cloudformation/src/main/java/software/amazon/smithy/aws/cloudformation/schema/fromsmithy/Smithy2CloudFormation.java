...
public final class Smithy2CloudFormation implements SmithyBuildPlugin {
    @Override
    ...
    public void execute(PluginContext context) {
        CloudFormationConverter converter = CloudFormationConverter.create();
        context.getPluginClassLoader().ifPresent(converter::classLoader);
        CloudFormationConfig config = CloudFormationConfig.fromNode(context.getSettings());
