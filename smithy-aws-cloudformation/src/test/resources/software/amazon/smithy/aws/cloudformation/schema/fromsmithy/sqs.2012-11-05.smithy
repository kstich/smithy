...
/// Definition of AWS::SQS::Queue Resource Type
...
// This structure is necessary to handle
...
/// <p></p>
structure AddPermissionRequest {
...
@error("client")
@httpError(400)
structure BatchEntryIdsNotDistinct {}

/// <p>The length of all the messages put together is more than the limit.</p>
@error("client")
@httpError(400)
structure BatchRequestTooLong {}
...
/// <p></p>
structure ChangeMessageVisibilityBatchRequest {
...
///         </p>
structure ChangeMessageVisibilityBatchRequestEntry {
...
structure ChangeMessageVisibilityBatchResult {
    /// <p>A list of <code>
    ///                <a>ChangeMessageVisibilityBatchResultEntry</a>
    ///             </code> items.</p>
    @required
...
///                <a>ChangeMessageVisibilityBatch</a>.</code>
///          </p>
structure ChangeMessageVisibilityBatchResultEntry {
    /// <p>Represents a message whose visibility timeout has been changed successfully.</p>
    @required
    Id: String,
}

structure ChangeMessageVisibilityRequest {
...
/// <p></p>
structure DeleteMessageBatchRequest {
...
structure DeleteMessageBatchRequestEntry {
...
structure DeleteMessageBatchResult {
    /// <p>A list of <code>
    ///                <a>BatchResultErrorEntry</a>
    ///             </code> items.</p>
    @required
...
///          </p>
structure DeleteMessageBatchResultEntry {
...
@error("client")
@httpError(400)
structure EmptyBatchRequest {}

/// <p></p>
structure GetQueueAttributesRequest {
...
structure GetQueueAttributesResult {
...
structure GetQueueUrlResult {
    ...
    @aws.cloudformation#additionalIdentifier
    @aws.cloudformation#readOnlyProperty
    @aws.cloudformation#propertyName("URL")
    QueueUrl: String,
}

/// <p>The specified attribute doesn't exist.</p>
@error("client")
structure InvalidAttributeName {}

/// <p>The <code>Id</code> of a batch entry in a batch request doesn't abide by the specification.</p>
@error("client")
@httpError(400)
structure InvalidBatchEntryId {}

/// <p>The specified receipt handle isn't valid for the current version.</p>
@error("client")
structure InvalidIdFormat {}
...
/// <p></p>
structure ListDeadLetterSourceQueuesRequest {
...
structure ListDeadLetterSourceQueuesResult {
...
structure ListQueueTagsRequest {
    /// <p>The URL of the queue.</p>
    @required
    QueueUrl: String,
}

structure ListQueueTagsResult {
...
structure MessageSystemAttributeValue {
    /// <p>Not implemented. Reserved for future use.</p>
    @xmlFlattened
    @xmlName("BinaryListValue")
    BinaryListValues: BinaryList,
...
@error("client")
@httpError(403)
structure PurgeQueueInProgress {}

/// <p></p>
structure PurgeQueueRequest {
...
@error("client")
structure ReceiptHandleIsInvalid {}
...
/// <p></p>
structure RemovePermissionRequest {
...
structure SendMessageBatchRequestEntry {
    ...
    ///          </important>
    @xmlFlattened
    @xmlName("MessageSystemAttribute")
...
///                <a>BatchResultErrorEntry</a>
///             </code> tag if the message fails.</p>
structure SendMessageBatchResult {
    /// <p>A list of <code>
    ///                <a>SendMessageBatchResultEntry</a>
    ///             </code> items.</p>
    @required
...
/// <p></p>
structure SetQueueAttributesRequest {
...
@error("client")
@httpError(400)
structure TooManyEntriesInBatchRequest {}
...
list ChangeMessageVisibilityBatchRequestEntryList {
    member: ChangeMessageVisibilityBatchRequestEntry,
}

list ChangeMessageVisibilityBatchResultEntryList {
    member: ChangeMessageVisibilityBatchResultEntry,
}

list DeleteMessageBatchRequestEntryList {
    member: DeleteMessageBatchRequestEntry,
}

list DeleteMessageBatchResultEntryList {
    member: DeleteMessageBatchResultEntry,
}

list MessageAttributeNameList {
    member: MessageAttributeName,
}
...
map MessageBodySystemAttributeMap {
    @xmlName("Name")
    key: MessageSystemAttributeNameForSends,
    @xmlName("Value")
    value: MessageSystemAttributeValue,
}
...
string MessageSystemAttributeName
...
string MessageSystemAttributeNameForSends
