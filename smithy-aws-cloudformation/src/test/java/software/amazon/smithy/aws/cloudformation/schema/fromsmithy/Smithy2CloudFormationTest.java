...
public class Smithy2CloudFormationTest {
    @Test
    public void pluginConvertsModel() {
        Model model = Model.assembler()
                .addImport(Smithy2CloudFormationTest.class.getResource("test-service.smithy"))
                .discoverModels()
                .assemble()
                .unwrap();
        ...
        PluginContext context = PluginContext.builder()
                ...
                .originalModel(model)
                .build();
        new Smithy2CloudFormation().execute(context);
